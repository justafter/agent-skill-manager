...
```json
{
  ...
  "items": [
    { "type": "skill", "skillName": "...", "target": "claude:project", "originalPath": "...", "backupPath": "..." }
  ]
}
```
...
```json
{
  "skills": {
    "comfyui-video-gen": {
      ...
      "projectInstalls": [{ "projectId": "obsidian-notes", "target": "claude:project", "checksum": "sha256:a1b2c3..." }]
    }
  }
}
```
